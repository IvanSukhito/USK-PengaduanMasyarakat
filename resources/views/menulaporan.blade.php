  ...
  <body class="text-center">
    ...
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
      ...
      <main role="main" class="inner cover">
        <h1 class="cover-heading">Layanan Pengaduan Masyarakat</h1>
        <table style="margin:70px;">
        <tr>
        <td>
          <a href="{{url('/pernahlapor')}}" class="btn btn-lg btn-primary">Pernah Lapor</a> &nbsp;
          <a href="{{url('/lapor')}}" class="btn btn-lg btn-secondary">Belum Pernah Lapor</a>
          </td>
