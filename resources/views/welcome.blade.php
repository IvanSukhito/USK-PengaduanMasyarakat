  ...
  <body class="text-center">
    ...
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
      ...
      <main role="main" class="inner cover">
        <h1 class="cover-heading">Layanan Pengaduan</h1>
        <p class="lead">Ini adalah halaman utama pengaduan masyrakat<br> klik <a href="#" style="color:#6495ED;"><b>Lapor</b></a> Jika ingin menyampaikan aspirasi</p>
        <p class="lead">
          <a href="{{url('/menulaporan')}}" class="btn btn-lg btn-secondary">Lapor</a>
        </p>
      </main>
