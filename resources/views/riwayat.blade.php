...
<html lang="en">
  ...
  <body class="text-center">
    ...
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
      ...
      <form  action="/riwayatidlaporan" >
     
      Cari Dengan ID Laporan
      <br>
      ...
      <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputEmail3" placeholder="Id Pelaporan anda" name="cari">
                    </div>
                 ...
                 <a style="color:red;">Lupa ID Laporan?</a>&nbsp; <a href="{{url('/history/riwayatnik')}}" style="color:#6495ED;">cari dengan nik atau nama</a>
      </main>
